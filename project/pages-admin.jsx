// ─── Dashboard ───────────────────────────────────────────
const DashboardPage = ({ users, onNavigate }) => {
        ...
        <div className="card">
          ...
          <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
            {byTeam.map(t => {
              ...
              return (
                <div key={t.id} onClick={() => onNavigate({ page: 'team-detail', teamId: t.id })}
...
// ─── Teams list ──────────────────────────────────────────
const TeamsPage = ({ users, onNavigate, onCreate }) => {
  return (
    <>
      <div className="page-head">
        <div>
...
Object.assign(window, { DashboardPage, TeamsPage });
