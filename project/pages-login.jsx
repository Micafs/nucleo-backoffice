...
const LoginPage = ({ onLogin }) => {
  const [email, setEmail] = React.useState('ana@empresa.com');
          ...
          <form className="login-form" onSubmit={submit}>
            <div className="field">
              ...
              <div className="input-wrap">
                ...
                <input className="input input--with-icon" type="email" value={email}
            ...
            <div className="field">
              ...
              <div className="input-wrap">
                ...
                <input className="input input--with-icon" type={showPw ? 'text' : 'password'} value={password}
            ...
            <button type="submit" className="btn btn--accent" style={{ width: '100%', height: 40, marginTop: 8 }} disabled={loading}>
